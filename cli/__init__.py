...
from .options import gset_full_dbdf, attach_yaml_opts, conditionalize_normalization_options_, postproc_tails_
...
def get_ui_options(ctx, full_dbdf, **yaml_opts):
    conditionalize_normalization_options_(ctx, yaml_opts)
