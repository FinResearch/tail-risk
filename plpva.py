        ...
        for B in xrange(reps):
            ...
            for qmin in qmins:
                ...
                if numpy.inf in numpy.abs(logvec):
                    # when +/- infinity exist in the array (i.e. log was given 0 as an argument), a can be set to 0
                    a = 0
                elif any(zq/qmin < 0):
                    # when -ve values exist in the array, but no infinity, then must use complex log
